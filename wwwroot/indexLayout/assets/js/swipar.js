                    ...
                    setTranslate: () => {
                        ...
                        for (let e = 0; e < a.length; e += 1) {
                            ...
                            s % 4 == 0
                                ...
                                n && (h = -h),
                                p || ((f = h), (h = 0));
                            const v = `rotateX(${p ? 0 : -i}deg) rotateY(${p ? i : 0
                        ...
                        if (
                            ...
                            if (p)
                                h.transform(
                                    `translate3d(0px, ${i / 2 + c.shadowOffset}px, ${-i / 2
                                ...
                                const e = Math.abs(m) - 90 * Math.floor(Math.abs(m) / 90),
                                    ...
                                    i = c.shadowOffset;
                                h.transform(
                                    `scale3d(${s}, 1, ${a}) translate3d(0px, ${r / 2 + i}px, ${-r / 2 / a
                                    }px) rotateX(-90deg)`
                                );
                            }
                        const f = o.isSafari || o.isWebView ? -l / 2 : 0;
                        s.transform(
                            `translate3d(0px,0,${f}px) rotateX(${t.isHorizontal() ? 0 : m
